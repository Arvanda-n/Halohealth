...
export default function PaymentReceipt() {
    ...
    const handleDownload = async () => {
        if (window.html2canvas) {
            window
                .html2canvas(receiptRef.current, { useCORS: true, scale: 2 })
                .then((canvas) => {
            ...
            <div style={s.mainContent}>
                <div style={s.card}>
                    <div ref={receiptRef} style={{ background: "white" }}>
                        ...
                        <div style={s.bodyContent}>
                            ...
                            {isMedicine && (
                                <>
                                    <span style={s.label}>Rincian Obat</span>
                                    <div
                                        style={{
                                            background: "#f8fafc",
                                            borderRadius: "16px",
                ...
                <div style={s.btnGroup}>
                    <div style={{ display: "flex", gap: "10px" }}>
                        <button onClick={handleDownload} style={s.btnSecondary}>
                    ...
                    {isConsultation ? (
                        <button
                            onClick={() =>
                                navigate(
                                    `/chat/${doctor?.user_id || doctor?.id}`,
                                    { state: { doctor: doctor } },
                                )
                            }
                            style={s.btnPrimary}
                        >
                            <MessageCircle size={22} /> MULAI CHAT
                        </button>
                    ) : (
                        <button
